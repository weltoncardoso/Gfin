...
class salesController extends controller{
 ...
 public function generate_nfe($id_sale) {
        ...
        $fatinfo = array(
            ...
            'vdesc' => '',//number_format($salesinfo['info']['desconto'], 2),
            'modFrete' => '9'
        );
        ...
        $data['user_email'] = $u->getEmail();
            ...
            if($u->hasPermission('sales_view')){
               ...
               if(isset($_POST['client_id']) && !empty($_POST['client_id'])){
                ...
                $s->addSale($u->getCompany(), $client_id, $salesman_id, $u->getId(), $quant, $status, $forma, $desconto);
    ...
    public function edit($id){
     ...
     public function emitir_nfe() {
        ...
        $nfeTools->setModelo('65');

        //Dados da NFe - infNFe
$cUF = '53'; //codigo numerico do estado
...
$cMunFG = '5200258';
$tpImp = '4'; //0=Sem geração de DANFE; 1=DANFE normal, Retrato; 2=DANFE normal, Paisagem;
...
$pathNFefile = "C:/wamp/www/contaazul/nfe/files/nfe/homologacao/assinadas/{$chave}-nfe.xml";
if (! $indSinc) {
    $pathProtfile = "C:/wamp/www/contaazul/nfe/files/nfe/homologacao/temporarias/2017/{$recibo}-retConsReciNFe.xml";
} else {
    $pathProtfile = "C:/wamp/www/contaazul/nfe/files/nfe/homologacao/temporarias/2017/{$recibo}-retEnviNFe.xml";
}
$saveFile = true;
